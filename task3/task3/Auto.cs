...
namespace task3
{
    ...
    internal class Auto
    {
        ...
        {
            get => bought_at; set => bought_at = DateTime.TryParseExact(
        ...
        public Auto(string[] fields_value)
        {
            ...
            else
            {
                ...
                Console.WriteLine($"Inappropriate amount of values. Given: {fields_value.Length}, Excpected: {properties.Length}");
            }
        }
